      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <ShoppingOutlined style={{ fontSize: 32, color: '#000' }} />
                    ...
                    {paginatedOrders.map((order) => (
                      <tr key={order.id} className="hover:bg-gray-50">
                        <td className="px-4 py-3">
                          <span className="font-mono text-sm text-black">#{(order.id || '').slice(0, 8).toUpperCase()}</span>
                        </td>
                        <td className="px-4 py-3">
                          <div>
                        ...
                        <td className="px-4 py-3">
                          <div className="text-sm">
                            ...
                            <p className="text-gray-500 line-clamp-1" title={order.shipping_address}>{order.shipping_address || '-'}</p>
                          </div>
                        </td>
